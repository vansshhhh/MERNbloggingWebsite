        ...
        <AnimationWrapper>
            <section>
                <div className="mx-auto max-w-[900px] w-full ">
                    ...
                    <textarea defaultValue={title} placeholder="Blog Title" className="w-full h-20 mt-10 text-4xl font-medium leading-tight outline-none resize-none placeholder:opacity-40"
