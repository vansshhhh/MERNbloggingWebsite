...
const SideNav = () => {
    ...
    useEffect(() => {
        ...
        // Check if pageStateTab.current is defined before calling click
        ...
        <>
            <section className="relative flex gap-10 py-0 m-0 max-md:flex-col"> 
                <div className="sticky top-[80px] z-30">
                    ...
                    <div className={"min-w-[200px] h-[calc(100vh-80px-60px)] md:h-cover md:sticky top-24 overflow-y-auto p-6 md:pr-0 md:border-grey md:border-r absolute max-md:top-[64px] bg-white max-md:w-[calc(100%+80px)] max-md:px-16 max-md:-ml-7 duration-500 " + (!showSideNav ? "max-md:opacity-0 max-md:pointer-events-none" : "max-md:opacity-100 pointer-events-auto")}>

                        <h1 className="mb-3 text-xl text-dark-grey">Dashboard</h1>
                        ...
                        <NavLink to="/dashboard/notifications" onClick={(e) => setPageState(e.target.innerText)} className="sidebar-link">
                            ...
                            {
                                new_notification_available ? <span className="absolute top-0 right-0 z-10 w-2 h-2 rounded-full bg-red"></span> : ""
                            }
                            </div>
                        ...
                        <h1 className="mt-20 mb-3 text-xl text-dark-grey">Settings</h1>
                        <hr className="mb-8 mr-6 -ml-6 border-grey" />
