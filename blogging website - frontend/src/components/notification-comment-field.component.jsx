...
const NotificationCommentField = ({_id, blog_author, index = undefined, replyingTo = undefined, setReplying, notification_id, notificationData}) => {
    ...
    return(
        <>
        <Toaster/>
        <textarea value={comment} onChange={(e) => setComment(e.target.value)} placeholder="Leave a reply..." className="pl-5 overflow-auto resize-none input-box placeholder:text-dark-grey h-[150px]"></textarea>

        <button className="px-10 mt-5 btn-dark" onClick={handleComment}>Reply</button>
