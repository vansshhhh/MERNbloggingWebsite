...
const SearchPage = () => {
    ...
    return(
       <section className="flex justify-center gap-10 h-cover">
            ...
            <div className="min-w-[40%] lg:min-w-[350px] max-w-min border-l border-dark-grey pl-8 pt-3 max-md:hidden">
                <h1 className="mb-8 text-xl font-medium">Users related to search <i className="mt-1 fi fi-rr-user"></i></h1>
