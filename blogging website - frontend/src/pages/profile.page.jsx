...
const ProfilePage = () => {
    ...
    let { personal_info:{fullname, username : profile_username, bio, profile_img }, account_info:{total_posts, total_reads}, social_links, joinedAt} =profile || profileDataStructure;
...

            {
                ...
                <section className="h-cover md:flex flex-row-reverse items-start gap-5 min-[1100px]:gap-12">
                    ...
                    <div className="flex flex-col max-md:items-center gap-5 min-w-[250px] md:w-[50%] md:pl-8 md:border-l border-grey md:sticky md:top-[100px] md:py-10">
                        <img src={profile_img} alt="" className="w-48 h-48 rounded-full bg-grey md:w-32 md:h-32 md:rounded-full"/>
                        ...
                        <div className="flex gap-4 mt-2">
                            {
                                profileId == username ? 
                                <Link to="/settings/edit-profile" className="rounded-md btn-light">
                                    Edit Profile
                                </Link>
                                : ""
                            }
                    ...
                    <InPageNavigation routes={["Blogs Published", "About"]} defaultHidden={["Trending Blogs"]}>
                            <>
