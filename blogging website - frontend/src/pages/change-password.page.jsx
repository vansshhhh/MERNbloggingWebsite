        ...
        <AnimationWrapper>
            ...
            <form ref={changePasswordForm}>
                ...
                <div className="py-10 w-full md:max-w-[400px]">
                    ...
                    <InputBox name="newPassword" type="password" className="profile-edit-input" placeholder="New Password" icon="fi-rr-lock"/>

                    <button className="px-10 mt-5 btn-dark" type="submit" onClick={handleSubmit}>Change Password</button>
                </div>
            </form>
